...
public class Lire {
    ...
    public static Date date() throws ParseException // Lire une date
    {
        System.out.println("Saisissez une date (JJ/MM/AAAA HH:MM) :");
        String str = S();
        if(str.matches("[0-9]{2}/[0-9]{2}/[0-9]{4} ([01]?[0-9]|2[0-3]):[0-5][0-9]")){
